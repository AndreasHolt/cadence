...
**Heterogeneity:** \`${GREEDY_HETEROGENEITY_MODE}\` · **Scoring:** \`${GREEDY_MOVE_SCORING_MODE}\` · **Profile:** \`${MATCHING_HETEROGENEITY_PROFILE}\` · **Adaptive scaler:** \`${MATCHING_ENABLE_ADAPTIVE_SCALER}\`
EOF
