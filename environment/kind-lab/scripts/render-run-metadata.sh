...
export RUN_NAME SCENARIO DEPLOY_MODE MATCHING_HETEROGENEITY_PROFILE \
  ...
  GREEDY_ENABLE_SWAP GREEDY_ENABLE_MULTI_MOVE \
...
**Heterogeneity:** \`${GREEDY_HETEROGENEITY_MODE}\` · **Scoring:** \`${GREEDY_MOVE_SCORING_MODE}\` · **Profile:** \`${MATCHING_HETEROGENEITY_PROFILE}\` · **Adaptive scaler:** \`${MATCHING_ENABLE_ADAPTIVE_SCALER}\` · **Swap:** \`${GREEDY_ENABLE_SWAP}\` · **Multi-move:** \`${GREEDY_ENABLE_MULTI_MOVE}\`
EOF
...
payload = {
    ...
    "greedy_enable_multi_move": os.environ["GREEDY_ENABLE_MULTI_MOVE"],
