...
type Store interface {
	...
	GetShardStatistics(ctx context.Context, namespace string, shardIDs []string) (map[string]ShardStatistics, error)
	UpdateShardStatistics(ctx context.Context, namespace, executorID string, shardMetrics map[string]ShardStatistics) error
